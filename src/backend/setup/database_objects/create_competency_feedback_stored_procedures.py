"""
Create stored procedures for competency feedback generation
"""
...
with app.app_context():
    # Create get_competency_results function (for known_roles)
    ...
    # Create get_unknown_role_competency_results function (for unknown_roles/task-based)
    db.session.execute(db.text("""
    ...
    db.session.commit()
    print("[SUCCESS] Created stored procedures:")
    print("  - get_competency_results(username, organization_id)")
    print("  - get_unknown_role_competency_results(username, organization_id)")
