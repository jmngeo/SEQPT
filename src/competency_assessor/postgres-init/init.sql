...
ALTER PROCEDURE public.insert_new_org_default_role_process_matrix(IN _organization_id integer) OWNER TO adminderik;
...
ALTER PROCEDURE public.update_role_competency_matrix() OWNER TO adminderik;
...
ALTER PROCEDURE public.update_role_competency_matrix(IN _organization_id integer) OWNER TO adminderik;
...
ALTER PROCEDURE public.update_unknown_role_competency_values(IN input_user_name text, IN input_organization_id integer) OWNER TO adminderik;
...
ALTER TABLE public.admin_user OWNER TO adminderik;
...
ALTER SEQUENCE public.admin_user_id_seq OWNER TO adminderik;
...
ALTER TABLE public.alembic_version OWNER TO adminderik;
...
ALTER TABLE public.app_user OWNER TO adminderik;
...
ALTER SEQUENCE public.app_user_id_seq OWNER TO adminderik;
...
ALTER TABLE public.competency OWNER TO adminderik;
...
ALTER SEQUENCE public.competency_id_seq OWNER TO adminderik;
...
ALTER TABLE public.competency_indicators OWNER TO adminderik;
...
ALTER TABLE public.competency_indicators_backup01112024 OWNER TO adminderik;
...
ALTER SEQUENCE public.competency_indicators_id_seq OWNER TO adminderik;
...
ALTER TABLE public.iso_activities OWNER TO adminderik;
...
ALTER SEQUENCE public.iso_activities_id_seq OWNER TO adminderik;
...
ALTER TABLE public.iso_processes OWNER TO adminderik;
...
ALTER SEQUENCE public.iso_processes_id_seq OWNER TO adminderik;
...
ALTER TABLE public.iso_system_life_cycle_processes OWNER TO adminderik;
...
ALTER SEQUENCE public.iso_system_life_cycle_processes_id_seq OWNER TO adminderik;
...
ALTER TABLE public.iso_tasks OWNER TO adminderik;
...
ALTER SEQUENCE public.iso_tasks_id_seq OWNER TO adminderik;
...
ALTER TABLE public.new_survey_user OWNER TO adminderik;
...
ALTER SEQUENCE public.new_survey_user_id_seq OWNER TO adminderik;
...
ALTER TABLE public.organization OWNER TO adminderik;
...
ALTER SEQUENCE public.organization_id_seq OWNER TO adminderik;
...
ALTER TABLE public.process_competency_matrix OWNER TO adminderik;
...
ALTER SEQUENCE public.process_competency_matrix_id_seq OWNER TO adminderik;
...
ALTER TABLE public.role_cluster OWNER TO adminderik;
...
ALTER SEQUENCE public.role_cluster_id_seq OWNER TO adminderik;
...
ALTER TABLE public.role_competency_matrix OWNER TO adminderik;
...
ALTER SEQUENCE public.role_competency_matrix_id_seq OWNER TO adminderik;
...
ALTER TABLE public.role_process_matrix OWNER TO adminderik;
...
ALTER SEQUENCE public.role_process_matrix_id_seq OWNER TO adminderik;
...
ALTER TABLE public.unknown_role_competency_matrix OWNER TO adminderik;
...
ALTER SEQUENCE public.unknown_role_competency_matrix_id_seq OWNER TO adminderik;
...
ALTER TABLE public.unknown_role_process_matrix OWNER TO adminderik;
...
ALTER SEQUENCE public.unknown_role_process_matrix_id_seq OWNER TO adminderik;
...
ALTER TABLE public.user_competency_survey_feedback OWNER TO adminderik;
...
ALTER SEQUENCE public.user_competency_survey_feedback_id_seq OWNER TO adminderik;
...
ALTER TABLE public.user_role_cluster OWNER TO adminderik;
...
ALTER TABLE public.user_se_competency_survey_results OWNER TO adminderik;
...
ALTER SEQUENCE public.user_se_competency_survey_results_id_seq OWNER TO adminderik;
...
ALTER TABLE public.user_survey_type OWNER TO adminderik;
...
ALTER SEQUENCE public.user_survey_type_id_seq OWNER TO adminderik;
